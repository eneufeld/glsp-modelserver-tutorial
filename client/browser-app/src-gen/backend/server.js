...
module.exports = (port, host, argv) => Promise.resolve()
    ...
    .then(function () { return Promise.resolve(require('examaple-glsp-theia/lib/node/backend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@eclipse-emfcloud/modelserver-theia/lib/node/backend-module')).then(load) })
    .then(function () { return Promise.resolve(require('examaple-modelserver/lib/node/backend-module')).then(load) })
